...
! set passed variables to public
  ...
  public :: allsky_verbose
  public :: cloud_mask_option, mask_threshold
  public :: hydrotable_format, hydrotype
...
!                                                          certain instruments. Set to greater than zero to use  
  ...
  logical :: allsky_verbose
  integer(i_kind) :: cloud_mask_option
  character(len=20) :: hydrotable_format
  character(len=30) :: hydrotype(6)
...
!$$$ end documentation block
    ...
    hydrotable_format = 'binary' ! hydrotable format ('binary' or 'netcdf')
    hydrotype(1) = 'WATER_CLOUD'    ! hydrotype for cloud water
    hydrotype(2) = 'ICE_CLOUD'      ! hydrotype for cloud ice
    hydrotype(3) = 'RAIN_CLOUD'     ! hydrotype for rain
    hydrotype(4) = 'SNOW_CLOUD'     ! hydrotype for snow
    hydrotype(5) = 'GRAUPEL_CLOUD'  ! hydrotype for graupel
    hydrotype(6) = 'HAIL_CLOUD'     ! hydrotype for hail
